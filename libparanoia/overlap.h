/* @(#)overlap.h	1.6 02/04/10 J. Schilling from cdparanoia-III-alpha9.8 */
/*
...
extern	void	i_paranoia_trim		__PR((cdrom_paranoia * p, long beginword, long endword));
extern	void	offset_adjust_settings	__PR((cdrom_paranoia * p,
						void (*callback) (long, int)));
extern	void	offset_add_value	__PR((cdrom_paranoia * p, offsets * o, long value,
						void (*callback) (long, int)));
