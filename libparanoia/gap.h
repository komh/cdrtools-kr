/* @(#)gap.h	1.9 02/04/10 J. Schilling from cdparanoia-III-alpha9.8 */
/*
...
extern int	i_stutter_or_gap	__PR((Int16_t * A, Int16_t * B, long offA, long offB,
						long gap));
...
extern void	analyze_rift_silence_f	__PR((Int16_t * A, Int16_t * B, long sizeA, long sizeB,
						long aoffset, long boffset,
